...
<div class="banner-top">
			...
			<div class="contact-bnr-w3-agile">
				<ul>
					...
					<li><i class="fa fa-phone" aria-hidden="true"></i>+91-9760947701</li>	
					<li class="s-bar">
						<div class="search">
 	...
 	<div class="about-wthree" id="about">
		  <div class="container">
				   <div class="ab-w3l-spa">
						   ...
						   <p class="about-para-w3ls">Located on the hills of Nice, a short distance from the famous Promenade des Anglais, Hotel Sunrise is one of the hotels in the Blue Coast able to satisfy the different needs of its guests with comfort and first rate services. It is only 2 km from the airport and from highway exits. The hotel has a large parking area , a real luxury in a city like Nice.</p>
						   <img src="images/about.jpg" class="img-responsive" alt="Hair Salon">
                                       ...
                                       <div class="w3ls-info-about">
											...
											<p>Best in City , Best in Price , Best in Service </p>
										</div>
		          </div>
		   	<div class="clearfix"> </div>
    </div>
			 	...
			 	<div class="advantage-block ">
					<i class="fa fa-credit-card" aria-hidden="true"></i>
			 		...
			 		<p><i class="fa fa-check" aria-hidden="true"></i>Breakfast</p>
			                <p><i class="fa fa-check" aria-hidden="true"></i>Private parking</p>
			 ...
			 <div class="col-md-6 advantage-grid right-w3ls wow zoomIn" data-wow-delay="0.3s">
			 	<div class="advantage-block">
					<i class="fa fa-clock-o" aria-hidden="true"></i>
			 		...
			 		<p><i class="fa fa-check" aria-hidden="true"></i>24h reception</p>
                                        <p><i class="fa fa-check" aria-hidden="true"></i>24h bar</p>
					...
					<ul class="slides">
						<li>
							<div class="w3layouts_work_grid_left">
								...
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/va.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								...
								<p>It was a good period staying this wonderful hotel.
                                                                    My birthday was during my staying in Sunrise hotel. 
                                                                      It was surprised to me I received a bottle of champagne for the gift from hotel. 
                                                                  Thank you very much. </p>
								<h5>Vaibhav Nagpal</h5>
								<p>17BLC1082</p>
							</div>
							<div class="clearfix"> </div>
						</li>
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/pr.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>The staff were very approachable and helpful.
                                                                    The breakfast was good. 
                                                                      They arranged for a taxi to pick us up from the airport and then back again at the end of our stay. 
                                                                      The suite was very good with comfortable furniture and the bed was comfortable too.
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/so.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>loved the location and the breakfast (including the timing!) 
                                                                     Would definitely stay here again! :) 
                                                                      P.s. if you could only look at installing a laundry room would be epic as there are no Laundromats within the vicinity of Old Town. :) </p>
								<h5>Somudeep Paul</h5>
								<p>17BLC1176</p>
							</div>
							<div class="clearfix"> </div>
						...
						<li>
							<div class="w3layouts_work_grid_left">
								<img src="images/5.jpg" alt=" " class="img-responsive" />
								<div class="w3layouts_work_grid_left_pos">
									<img src="images/ani.jpg" alt=" " class="img-responsive" />
								</div>
							</div>
							<div class="w3layouts_work_grid_right">
								<h4>
								...
								<p>Great location, really pleasant and clean rooms, but the thing that makes this such a good place to stay are the staff. 
                                                                     All of the people are incredibly helpful and generous with their time and advice. 
                                                                        We travelled with lots of luggage and despite the stairs up to the elevator this was one of the nicest places we stayed. </p>
								<h5>Anirudh Housur</h5>
								<p>17BLC1147</p>
							</div>
							<div class="clearfix"> </div>
						</li>
...
<section class="contact-w3ls" id="contact">
	<div class="container">
		...
		<div class="col-lg-6 col-md-6 col-sm-6 contact-w3-agile1" data-aos="flip-right">
			...
			<p class="contact-agile1"><strong>Phone :</strong>+91-9760947701– APE 551 A</p>
			<p class="contact-agile1"><strong>Email :</strong> <a href="mailto:name@example.com">INFO@SUNRISE.COM</a></p>
			<p class="contact-agile1"><strong>Address :</strong> 50, Avenue de la Lanterne
3 Avenue Costa Bella – 06200 Nice, France</p>
...
<!-- /contact -->
			<div class="copy">
		        <p>© 2020 SUNRISE . All Rights Reserved | Design by <a href="index.php">DBMS J Component</a> </p>
		    </div>
<!--/footer -->
<!-- js -->
